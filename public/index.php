...
&& !empty($_POST["email"]) && !empty($_POST["password"]) && !empty($_POST["connexion"])
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <form action="email.php" method="post" target="blank">
                <div class="card-body">
                  <form role="form">
                  ...
                  <label>Email</label>
                    ...
                    <div class="mb-3">
                <input type="password" class="form-control" placeholder="Entrer le mot de passe" aria-label="Password" aria-describedby="password-addon" required>
                           
              
              </div>

                    <input type="submit" id='submit' class="btn bg-gradient-info w-100 mt-4 mb-0" value='Connexion'>
